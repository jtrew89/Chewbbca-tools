...
def main(args):
	...
	query_df = query_df.applymap(str) #make df str otherwise there is issue with replace
	...
	if not sts_results:
		...
		print(f'Of {tot_isos} isolates, {tot_nov} had novel STs and {tot_iden} were already in the DB')
